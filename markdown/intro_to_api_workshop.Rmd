...
* will only run if you have an appropriately formatted filed `credentials/socrata_app_credentials.yml` with valid CDC API credentials
...
* will only run if you have an appropriately formatted filed `credentials/purpleair_api_credentials.yml` with valid PurpleAir API credentials
